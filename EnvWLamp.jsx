...
Command: npx gltfjsx@6.2.16 envWLamp.glb --transform 
Files: envWLamp.glb [6.59MB] > /home/adrianc/Downloads/adfbbc87-0880-4878-ba29-6974dc8aae45/envWLamp-transformed.glb [381.85KB] (94%)
*/
...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Obj_012.geometry} material={materials.Glass_Milky__1} position={[0.021, -0.732, -0.117]} rotation={[-Math.PI / 2, 0, 2.353]} scale={0} />
      <mesh geometry={nodes.Obj_000001.geometry} material={materials.Material__3} position={[0.055, -0.824, -0.15]} rotation={[-Math.PI / 2, 0, 2.353]} scale={0} />
      <mesh geometry={nodes.Circle002.geometry} material={materials.BlackMetal} position={[0.055, -0.824, -0.15]} rotation={[-Math.PI / 2, 0, 2.353]} scale={0} />
